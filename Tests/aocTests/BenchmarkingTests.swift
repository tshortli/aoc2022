...
extension BenchmarkingTests {
  var defaultSolvers: [any Solver] {
    [
      ...
      Day10.createForPuzzleInput(),
      Day11.createForPuzzleInput(),
      Day12.createForPuzzleInput(),
      Day13.createForPuzzleInput(),
      Day14.createForPuzzleInput(),
      Day15.createForPuzzleInput(),
      Day16.createForPuzzleInput(),
      Day17.createForPuzzleInput(),
    ]
  }
}
